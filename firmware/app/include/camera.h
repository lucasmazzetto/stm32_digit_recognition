...
// Full sensor output before the DCMI crop window is applied
#define CAMERA_SENSOR_FRAME_WIDTH 160U
#define CAMERA_SENSOR_FRAME_HEIGHT 120U

// Center window delivered to RAM by the DCMI hardware crop
#define CAMERA_FRAME_WIDTH 120U
...
// DCMI crop units: PIXCLK cycles horizontally (2 per YUV422 pixel), lines
// vertically
#define CAMERA_CROP_X0_CYCLES                                 \
    (((CAMERA_SENSOR_FRAME_WIDTH - CAMERA_FRAME_WIDTH) / 2U) * \
     CAMERA_FRAME_BYTES_PER_PIXEL)
#define CAMERA_CROP_XSIZE_CYCLES \
    (CAMERA_FRAME_WIDTH * CAMERA_FRAME_BYTES_PER_PIXEL)
#define CAMERA_CROP_Y0_LINES \
    ((CAMERA_SENSOR_FRAME_HEIGHT - CAMERA_FRAME_HEIGHT) / 2U)
#define CAMERA_CROP_YSIZE_LINES CAMERA_FRAME_HEIGHT
#define SCCB_MAX_RETRIES 3U
#define SCCB_RECOVERY_DELAY_MS 2U
#define SCCB_TABLE_SETTLE_DELAY_MS 10U
