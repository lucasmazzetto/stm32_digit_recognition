...
- `USART2` configured for logs, with TX DMA enabled
- `PB1` and `PB12` configured for camera `PWDN` and `RESET`

The application layer is still a static inference demo and does not yet capture live camera frames.
